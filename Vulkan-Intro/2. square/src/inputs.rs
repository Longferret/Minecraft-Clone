...
// Structure used to hold information on key pressed and mouse moved
#[derive(Default)]
...
impl InputHandle {
    // From the information in self, update the player position and the angles of view 
    ...
    // Store key input information with their time when pressed
